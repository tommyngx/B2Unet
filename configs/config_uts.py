...
class Config:
    def __init__(self, model_name="unetplusplus"):
        ...
        # Data
        self.DATA_DIR = "/projects/BMammo/Segmentation/Data/CSAW_1class"  # Update with the path to your dataset directory
        ...
        # Model Saving
        self.MODEL_SAVE_PATH = f"/projects/BMammo/Segmentation/Data/Models/{self.PROJECT_NAME}"
